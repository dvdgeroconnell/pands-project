...
def do_menu():
    ...
    print("1 for a statistical summary of the iris data set to be written to a file")
    print("2 for a set of histograms representing the iris data set variables written to a file")
    print("3 for histograms and density plots representing the individual iris variables written to 4 files")
    print("4 for a set of scatter plots representing the iris data set variables")
    print("5 for the correlation and heatmaps of the iris data set variables across the species")
